  ...
  return (
    <div className="w-full h-full flex flex-col p-4 sm:p-6 md:p-10 space-y-6 md:space-y-8 pb-20 max-w-7xl mx-auto overflow-y-auto scrollbar-hide">
       ...
       <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/40 p-4 sm:p-6 md:p-8 rounded-[24px] md:rounded-[48px] border border-gray-100 backdrop-blur-md">
          <div>
             <h1 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 tracking-tighter">Leave Command</h1>
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full md:w-auto">
             <div className="relative w-full sm:w-64">
                ...
                <input placeholder="Search requests..." className="w-full pl-10 pr-4 py-2.5 rounded-2xl bg-gray-50 border border-gray-200 text-gray-900 text-xs outline-none focus:ring-2 focus:ring-brand-500/20" />
             </div>
             <button className="bg-brand-600 text-white px-8 py-3.5 rounded-2xl text-[11px] font-black uppercase tracking-widest hover:bg-brand-500 transition-all shadow-xl shadow-brand-600/30 flex items-center justify-center gap-2 w-full sm:w-auto">
       ...
       <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2 glass-light rounded-[24px] md:rounded-[40px] border border-gray-100 overflow-hidden flex flex-col">
             <div className="p-4 sm:p-6 md:p-8 border-b border-gray-100 flex flex-col sm:flex-row gap-4 sm:items-center sm:justify-between bg-gray-50">
                <div className="flex items-center gap-4">
                   ...
                   <h2 className="text-base sm:text-lg md:text-xl font-black text-gray-900 tracking-tight">Request Protocol Queue</h2>
                </div>
                         ...
                         <tbody>
                            {requests.filter(r => activeTab === 'pending' ? r.status === 'Pending' : r.status !== 'Pending').map((req, idx) => (
                               <tr key={idx} className="border-b border-gray-100 hover:bg-white/[0.02] transition-colors group">
                                  <td className="p-6">
                                     <div className="flex items-center gap-4">
                                        <div className="w-10 h-10 rounded-xl overflow-hidden bg-brand-600 p-0.5 shrink-0">
          ...
          <div className="space-y-6 md:space-y-8">
             <div className="glass-light p-4 sm:p-6 md:p-8 rounded-[24px] md:rounded-[40px] border border-gray-100 relative overflow-hidden group">
                ...
                <h3 className="text-lg sm:text-xl font-black text-gray-900 tracking-tight mb-2">Workload Analysis</h3>
             ...
             <div className="bg-white rounded-[24px] md:rounded-[40px] p-4 sm:p-6 md:p-8 border border-gray-200 relative overflow-hidden">
                <div className="flex items-center gap-3 mb-6 sm:mb-8">
                   <div className="w-10 h-10 bg-rose-500/20 rounded-xl flex items-center justify-center text-rose-400 shrink-0">
                      <AlertTriangle size={20} />
                   </div>
                   <div>
                      <h3 className="text-base sm:text-lg font-black text-gray-900 tracking-tight">Critical Alerts</h3>
                ...
                <button className="w-full py-3.5 bg-gray-50 border border-gray-100 rounded-2xl mt-6 text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-gray-900 transition-all">Review Schedule</button>
             </div>
          </div>
       </div>
    </div>
