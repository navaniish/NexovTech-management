  ...
  return (
    <div className="space-y-8 pb-20 max-w-7xl mx-auto">
       ...
       <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 bg-white/40 p-8 rounded-[48px] border border-gray-100 backdrop-blur-md">
          <div>
             <h1 className="text-4xl font-black text-gray-900 tracking-tighter">Talent Command</h1>
          ...
          <div className="flex items-center gap-3">
             <div className="relative">
                ...
                <input placeholder="Search candidates..." className="w-64 pl-10 pr-4 py-2.5 rounded-2xl bg-gray-50 border border-gray-200 text-gray-900 text-xs outline-none focus:ring-2 focus:ring-brand-500/20" />
             </div>
             <button 
       ...
       <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 glass-light rounded-[40px] border border-gray-100 overflow-hidden flex flex-col">
             <div className="p-8 border-b border-gray-100 flex items-center justify-between bg-gray-50">
                <div className="flex items-center gap-4">
                   ...
                   <h2 className="text-xl font-black text-gray-900 tracking-tight">Active Recruitment Pipeline</h2>
                </div>
             ...
             <div className="flex-1 overflow-y-auto custom-scrollbar p-6">
                {activeTab === 'pipeline' ? (
                   <div className="space-y-4">
                      {candidates.length === 0 ? (
                         ...
                         candidates.map((can, idx) => (
                            <div key={idx} className="flex items-center justify-between p-6 bg-gray-50 rounded-[32px] border border-gray-100 hover:border-brand-500/30 transition-all group">
                               <div className="flex items-center gap-5">
                                  <div className="w-12 h-12 bg-brand-600/20 rounded-2xl flex items-center justify-center text-brand-400 group-hover:bg-brand-600 group-hover:text-gray-900 transition-all">
                                     <FileText size={22} />
                                  </div>
                                  <div>
                                     <h4 className="text-sm font-black text-gray-900">{can.name}</h4>
                                     <p className="text-[9px] font-black text-gray-300 uppercase tracking-widest mt-0.5">{can.role} • {can.experience} Exp</p>
                                  </div>
                               </div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      {vacancies.map(v => (
                         <div key={v.id} className="p-8 bg-white border border-gray-100 rounded-[40px] relative overflow-hidden group">
                            ...
                            <h4 className="text-xl font-black text-gray-900 tracking-tight">{v.title}</h4>
                            ...
                            <div className="flex items-center justify-between mt-8 pt-8 border-t border-gray-100">
                               <div>
                                  <p className="text-[18px] font-black text-gray-900">{v.applications}</p>
                                  <p className="text-[8px] font-black text-gray-300 uppercase tracking-widest">Applications</p>
                               </div>
                               <button className="px-6 py-2.5 bg-gray-50 rounded-xl text-[9px] font-black uppercase tracking-widest text-gray-400 hover:text-gray-900 hover:bg-white/10 transition-all border border-gray-100">View Board</button>
                            </div>
                         </div>
                      ))}
                   </div>
          ...
          <div className="space-y-8">
             <div className="glass-light p-8 rounded-[40px] border border-gray-100 relative overflow-hidden group">
                ...
                <h3 className="text-xl font-black text-gray-900 tracking-tight mb-2">Neural Sourcing</h3>
             ...
             <div className="bg-white rounded-[40px] p-8 border border-gray-200">
                <div className="flex items-center gap-3 mb-8">
                   <div className="w-10 h-10 bg-indigo-500/20 rounded-xl flex items-center justify-center text-indigo-400">
                      <TrendingUp size={20} />
                   </div>
                   <h3 className="text-lg font-black text-gray-900 tracking-tight">Hiring Velocity</h3>
                </div>
                <div className="space-y-4">
                   <div className="flex justify-between items-end border-b border-gray-100 pb-4">
                      <div>
                         <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest">Avg Time-to-Hire</p>
                         <p className="text-2xl font-black text-gray-900">12.4 Days</p>
                      </div>
